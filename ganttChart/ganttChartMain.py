...
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 1, 26)), color='springgreen', linestyle=linestyle, linewidth=linewidth, ymin=.025, ymax=.75)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 1, 28)), color='blue', linestyle=linestyle, linewidth=linewidth,  ymin=.025, ymax=.75)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 2, 2)), color='gold', linestyle=linestyle, linewidth=linewidth,  ymin=.025)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 2, 9)), color='gold', linestyle=linestyle, linewidth=linewidth,  ymin=.025)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 2, 11)), color='red', linestyle=linestyle, linewidth=linewidth,  ymin=.025)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 2, 16)), color='springgreen', linestyle=linestyle, linewidth=linewidth,  ymin=.025)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 2, 17)), color='red', linestyle=linestyle, linewidth=linewidth,  ymin=.025)
plt.axvline(x=mdates.date2num(datetime.datetime(2021, 2, 22)), color='blue', linestyle=linestyle, linewidth=linewidth,  ymin=.025)
